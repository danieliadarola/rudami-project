...
import { promptCopiloto, promptInformeRapido, promptInformeCompleto, promptTranscripcion } from './prompts'
...
export type { DatosClinicos, ModoIA, ResultadoIA, CopilotoOutput, ExtraccionOutput } from './types'
