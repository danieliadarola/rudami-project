...
export default function PrimeraSesion({ params }: { params: Promise<{ id: string, episodioId: string }> }) {
  ...
  const analizarConCopiloto = async (formActual: typeof form) => {
    ...
    try {
      const response = await fetch('/api/generar-informe', {
        ...
        body: JSON.stringify({
          modo: 'copiloto',
          motivo_consulta: formActual.motivo_episodio || paciente.motivo_consulta,
          antecedentes: formActual.antecedentes_episodio || paciente.antecedentes,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/generar-informe', {
        ...
        body: JSON.stringify({
          modo: 'informe',
          motivo_consulta: form.motivo_episodio || paciente?.motivo_consulta,
          antecedentes: form.antecedentes_episodio || paciente?.antecedentes,
    ...
    <main className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Valoración inicial</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-3 space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h2 className="text-sm font-semibold text-gray-900 mb-1">Motivo de la consulta</h2>
              <p className="text-xs text-gray-400 mb-4">Información específica de esta consulta</p>
              ...
              <div className="mb-4">
                ...
                <textarea
                  name="motivo_episodio"
                  required
                  value={form.motivo_episodio}
              ...
              <div>
                ...
                <textarea
                  name="antecedentes_episodio"
                  value={form.antecedentes_episodio}
                  onChange={handleChange}
                  rows={2}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Cirugías previas, tratamientos anteriores, antecedentes relacionados..."
                />
              </div>
            </div>

            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h2 className="text-sm font-semibold text-gray-900 mb-4">Anamnesis completa</h2>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Describe detalladamente los síntomas, cuándo empezaron, cómo evolucionan..."
                />
              </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h2 className="text-sm font-semibold text-gray-900 mb-4">Exploración física inicial</h2>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <textarea
                ...
                rows={2}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Observaciones, plan inicial, objetivos del tratamiento..."
              />
            </div>
            ...
            {loading && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-600 text-sm text-center">
                  Generando valoración inicial con IA...
                </p>
              </div>
            )}
            ...
            <div className="flex gap-3">
              ...
              >
                {loading ? 'Guardando...' : 'Guardar valoración inicial'}
              </button>
            </div>
